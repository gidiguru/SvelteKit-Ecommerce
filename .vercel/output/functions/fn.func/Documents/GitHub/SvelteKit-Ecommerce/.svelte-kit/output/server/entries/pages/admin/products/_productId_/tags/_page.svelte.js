import { c as create_ssr_component, s as spread, d as escape_object, v as validate_component, f as each, e as escape } from "../../../../../../chunks/ssr.js";
...
import { s as subscribe, h as compute_rest_props } from "../../../../../../chunks/lifecycle.js";
...
const Circle_minus = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  const iconNode = [
    ["circle", { "cx": "12", "cy": "12", "r": "10" }],
    ["path", { "d": "M8 12h8" }]
  ];
  return `${validate_component(Icon, "Icon").$$render($$result, Object.assign({}, { name: "circle-minus" }, $$props, { iconNode }), {}, {
    default: () => {
      return `${slots.default ? slots.default({}) : ``}`;
    }
  })}`;
});
const MinusCircle = Circle_minus;
