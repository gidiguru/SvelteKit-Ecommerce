...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$$result.head += `<!-- HEAD_svelte-e2jnhg_START -->${$$result.title = `<title>Synergetics Shop</title>`, ""}<meta name="description" content="Sediment Art, beauty crystalized and shipped straight to you."><!-- HEAD_svelte-e2jnhg_END -->`, ""} ${validate_component(CldOgImage, "CldOgImage").$$render(
    $$result,
    {
