  ...
  return `${validate_component(Card, "Card.Root").$$render($$result, { class: "w-[400px]" }, {}, {
    default: () => {
      return `${validate_component(Card_header, "Card.Header").$$render($$result, {}, {}, {
        ...
        default: () => {
          return `<div class="flex flex-col justify-center items-center w-full gap-4">${validate_component(Button, "Button").$$render($$result, { href: "/auth/signin", class: "w-full" }, {}, {
            default: () => {
              return `${validate_component(Star$1, "Star").$$render($$result, { class: "mr-2 h-4 w-4" }, {}, {})}
				Log In or Sign Up`;
            }
