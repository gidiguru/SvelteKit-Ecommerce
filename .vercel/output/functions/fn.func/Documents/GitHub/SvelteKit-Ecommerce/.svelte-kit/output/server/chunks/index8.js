import { o as onDestroy, m as get_store_value, d as createEventDispatcher, l as setContext, g as getContext, s as subscribe, h as compute_rest_props } from "./lifecycle.js";
import { c as create_ssr_component, s as spread, d as escape_object, a as add_attribute, v as validate_component, b as escape_attribute_value } from "./ssr.js";
import { d as derived, w as writable, a as readable, r as readonly } from "./index3.js";
import { I as nanoid, J as createFocusTrap$1, a as cn } from "./utils.js";
...
const Drawer_description = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $$restProps = compute_rest_props($$props, ["el", "class"]);
  let { el = void 0 } = $$props;
  let { class: className = void 0 } = $$props;
  if ($$props.el === void 0 && $$bindings.el && el !== void 0)
  ...
  do {
    $$settled = true;
    $$result.head = previous_head;
    $$rendered = `${validate_component(Description, "DrawerPrimitive.Description").$$render(
      $$result,
      Object.assign(
        {},
        {
