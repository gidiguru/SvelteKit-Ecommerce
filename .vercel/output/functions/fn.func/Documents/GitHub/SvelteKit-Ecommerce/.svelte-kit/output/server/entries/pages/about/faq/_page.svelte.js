import { c as create_ssr_component, s as spread, d as escape_object, v as validate_component } from "../../../../chunks/ssr.js";
import { h as compute_rest_props, s as subscribe } from "../../../../chunks/lifecycle.js";
import { r as setCtx, t as getAttrs, u as setItem, v as getCtx, w as getTrigger, x as getContent, a as cn } from "../../../../chunks/utils.js";
import "clsx";
import { c as createDispatcher } from "../../../../chunks/events.js";
import { I as Icon } from "../../../../chunks/Icon.js";
import { s as slide } from "../../../../chunks/index5.js";
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="flex flex-col md:flex-row md:p-16 bg-white grow min-h-screen"><div class="md:w-1/3 md:flex flex-col gap-2 hidden" data-svelte-h="svelte-vrk0i2"><h2 class="text-4xl font-jura">FAQ</h2> <h4>Answers to common questions.</h4></div> <div class="grow px-4"><div class="w-full flex flex-col pt-4 px-2" data-svelte-h="svelte-b4nuj6"><h3 class="text-center font-jura text-5xl pb-8">What is the Synergetics Shop?</h3> <p class="text-center text-lg font-light pb-4">We identify cutting edge technology products that make your life easier.</p> <p class="text-center text-lg font-light pb-8">We sell made to order prints, and have them delivered right to your door.</p></div> ${validate_component(Root, "Accordion.Root").$$render($$result, { class: "w-full" }, {}, {
    default: () => {
